...
if __name__=="__main__":
    ...
    rewrite_fetures(modified_scores, coherency_features_set, seo_features_file, new_features_with_harmonic_file,
    ...
    betas = [i for i in range(start=0,stop=1,step=0.1)]
    for beta in betas:
