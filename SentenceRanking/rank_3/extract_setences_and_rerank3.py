...
if __name__=="__main__":
    ...
    reference_docs = {q:ranked_lists[q][2].replace("EPOCH","ROUND") for q in ranked_lists}
    winner_docs = {q:ranked_lists[q][:2] for q in ranked_lists}
    ...
    summaries = {}
    labels_file=open("labels_3", 'w')
    sentence_data_file = open("senetces_add_remove_3", "w")
    index=1
    for query in sentence_map:
        ...
        for sentence in sentence_map[query]:
            ...
            for reference_sentence in reference_sentences:
                ...
                add = open("/home/greg/auto_seo/scripts/add_remove_3",'w',encoding="utf8")
                ...
                features_dir = "Features3"
                feature_file = "features_3_"+run_name
                create_features_file(features_dir, params.path_to_index, params.queries_xml,feature_file,"/home/greg/auto_seo/scripts/add_remove_3","")
                ...
                addition = max(2-lists[query].index(reference_doc),0)
