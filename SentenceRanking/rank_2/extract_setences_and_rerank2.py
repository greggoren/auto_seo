...
if __name__=="__main__":
    ...
    summaries = {}
    labels_file=open("labels_2", 'w')
    sentence_data_file = open("senetces_add_remove_2", "w")
    index=1
    for query in sentence_map:
        ...
        for sentence in sentence_map[query]:
            ...
            for reference_sentence in reference_sentences:
                ...
                add = open("/home/greg/auto_seo/scripts/add_remove_2",'w',encoding="utf8")
                ...
                features_dir = "Features_2"
                feature_file = "features_2"+run_name
                ...
                addition = max(1-lists[query].index(reference_doc),0)
