...
import subprocess
import sys
from CrossValidationUtils import rank_svm_implementation as s
from CrossValidationUtils import svm_handler as sv
import operator
...
def cross_validation(features_file,qrels_file,summary_file,append_file = ""):
    ...
    for train, test in folds:
        ...
        test_scores_file=chosen_model.predict(X[test],chosen_model,fold_number)
